...
- What is it 'in' the texts that provides evidence for your argument? <!-- .element: class="fragment "-->
...
- Television news that Japanese people choose to watch <!-- .element: class="fragment "-->
- Highest rated programmes across all major networks (otherwise the sample would be dominated by NHK) <!-- .element: class="fragment "-->
...
- Top rated shows (based on an average rating taken over several previous months) <!-- .element: class="fragment "-->
- At least one show from each major network <!-- .element: class="fragment "-->
- Two 'rolling weeks' during a period with no major 'media events' <!-- .element: class="fragment "-->
